  ...
  return (
    ...
    <section id='Home' className="relative w-full min-h-screen overflow-hidden pt-32 bg-mesh-purple">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        />
        <Spotlight
          className="hidden md:block top-10 left-full h-[80vh] w-[50vw]"
          ...
          <div className="flex-1">
            <div className="flex justify-center">
              <div className="max-w-xl">
                ...
                <p className="text-center text-white/70 text-sm font-serif sm:text-base md:text-lg mb-8 max-w-xl leading-relaxed">
